...
export function AdminFileRegister() {
    ...
    const filteredRecords = useMemo(() => {
        ...
        return records.filter((record) => {
            ...
            return matchesGroup && matchesStatus && matchesRenewalStatus && matchesSearch
        })
    }, [records, searchQuery, selectedGroup, selectedStatus, selectedRenewalStatus])
                ...
                <div className="flex flex-col">
                    ...
                    {record.uploadedFileUrl ? (
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="text-xs font-semibold text-[#00a69a] hover:underline"
                        >
                            View uploaded file
                        </a>
                    ) : null}
        ...
        { key: 'status', header: 'Status', cell: (record) => <StatusHighlighter value={record.status} /> },
        {
            ...
            cell: (record) => (
                <div className="flex items-center justify-center gap-1">
                    <button onClick={() => openEditDrawer(record)} className="p-1.5 bg-teal-500 text-white rounded hover:bg-teal-600" title="Edit">
                        <Edit2 className="h-4 w-4" />
                    </button>
                    <button onClick={() => handleDelete(record.id)} className="p-1.5 bg-red-500 text-white rounded hover:bg-red-600" title="Delete">
    ...
    return (
        <div className="flex h-full flex-col">
            ...
            <ActionBar onAdd={openAddDrawer} addLabel="Add File Entry" />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <input
                                ...
                                className="block w-full rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-900 file:mr-3 file:rounded-lg file:border-0 file:bg-[#dff8f5] file:px-3 file:py-1.5 file:text-sm file:font-semibold file:text-[#007f76] hover:bg-white focus:border-[#00b3a7] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#00b3a7]/20 dark:border-white/10 dark:bg-black dark:text-gray-100 dark:hover:bg-white/5"
                            />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="h-24 w-full rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-900 transition-all placeholder:text-gray-400 hover:bg-white focus:border-[#00b3a7] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#00b3a7]/20 dark:border-white/10 dark:bg-black dark:text-gray-100 dark:hover:bg-white/5"
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button
                            ...
                            className="rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#01867c]"
                        >
