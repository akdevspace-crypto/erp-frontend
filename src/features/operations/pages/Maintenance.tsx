            ...
            <Drawer isOpen={drawerOpen} onClose={() => setDrawerOpen(false)} title="Add Maintenance Ticket" size="md">
                <form onSubmit={handleCreateTicket} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={createTicket.isPending} className="rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white shadow-sm disabled:opacity-60">
