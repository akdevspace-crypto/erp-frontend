            ...
            cell: (record) => {
                ...
                return (
                    <button
                        ...
                        className="rounded-lg bg-teal-600 px-3 py-2 text-xs font-black text-white shadow-sm hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                        Mark {nextStatus}
                    </button>
                )
            ...
            <PageHeader
                ...
                action={
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-teal-600 px-4 py-3 text-sm font-black text-white shadow-sm hover:bg-teal-700"
                    >
                    ...
                    <form onSubmit={submitWaste} className="w-full max-w-xl rounded-3xl bg-white shadow-2xl">
                        ...
                        <div className="grid gap-4 px-6 py-5">
                            <label className="grid gap-2 text-sm font-black text-slate-700">
                                ...
                                <select
                                    ...
                                    className="rounded-xl border border-slate-200 px-4 py-3 font-semibold outline-none focus:border-teal-400"
                                >
                        ...
                        <div className="flex justify-end gap-3 border-t border-slate-100 px-6 py-5">
                            ...
                            <button
                                ...
                                className="rounded-xl bg-teal-600 px-4 py-3 text-sm font-black text-white hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-60"
                            >
                                Save Waste
                            </button>
                        </div>
