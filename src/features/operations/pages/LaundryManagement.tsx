            ...
            cell: (record) => {
                ...
                return (
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-lg bg-teal-50 px-3 py-1.5 text-xs font-black text-teal-700 transition hover:bg-teal-100 disabled:opacity-60"
                    >
            ...
            <Drawer isOpen={drawerOpen} onClose={() => setDrawerOpen(false)} title="Add Laundry Record" size="md">
                <form onSubmit={handleCreateLaundry} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={createLaundry.isPending || !patients.length} className="rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white shadow-sm disabled:opacity-60">
