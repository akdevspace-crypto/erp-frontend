            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1.1fr_1.9fr]">
                <section className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-black">
                    <div className="flex items-center gap-3">
                        <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-teal-50 text-[#00a99d]">
                    ...
                    <div className="mt-5 flex flex-wrap gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-xl bg-[#00a99d] px-4 py-2 text-sm font-black text-white shadow-sm hover:bg-[#008f86] disabled:cursor-not-allowed disabled:bg-slate-200 disabled:text-slate-500"
                        >
