        ...
        <div className="flex h-full flex-col space-y-6 bg-transparent dark:bg-black">
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
                {[
                    ...
                    { label: 'Gross Pay', value: money(summary.gross), tone: 'bg-teal-50 text-teal-700' },
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <button
                    type="button"
                    onClick={() => refetch()}
                    className="inline-flex items-center gap-2 rounded-xl bg-[#00a99d] px-4 py-2 text-sm font-black text-white shadow-sm hover:bg-[#008f86]"
                >
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {row.status === 'Processed' ? (
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-1 rounded-lg bg-[#00a99d] px-2 py-1 text-xs font-black text-white shadow-sm hover:bg-[#008f86] disabled:cursor-not-allowed disabled:bg-slate-200 disabled:text-slate-500"
                    ...
                    <div className="w-full max-w-2xl overflow-hidden rounded-3xl bg-white shadow-2xl">
                        ...
                        <div className="space-y-5 p-6">
                            <div className="rounded-2xl border border-teal-100 bg-teal-50 p-4">
                                <p className="text-xs font-black uppercase tracking-wide text-teal-700">Employee</p>
                            ...
                            <div className="flex justify-end gap-3 border-t border-slate-100 pt-4">
                                <button
                                    ...
                                    className="rounded-xl bg-[#00a99d] px-4 py-2 text-sm font-black text-white shadow-sm hover:bg-[#008f86]"
                                >
                                    Print
                                </button>
                                <button
