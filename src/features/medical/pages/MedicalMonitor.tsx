...
const statusActionClass = 'inline-flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-600 shadow-sm hover:border-[#00b3a7] hover:text-[#00b3a7] dark:border-white/10 dark:bg-black dark:text-gray-300'
...
export function MedicalMonitor() {
    ...
    const columns: Column<MedicalAssignment>[] = [
        { key: 'refNo', header: 'Ref No', sortable: true, cell: (row) => <span className="font-bold text-[#01867c]">{row.refNo}</span> },
        {
            key: 'staff',
            header: 'Doctor / Nurse',
            cell: (row) => (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="min-h-[96px] w-full rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-900 outline-none transition-all focus:border-[#00b3a7] focus:bg-white focus:ring-2 focus:ring-[#00b3a7]/20 dark:border-white/10 dark:bg-black dark:text-gray-100"
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={createAssignment.isPending} className="rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white disabled:opacity-60">
