            ...
            cell: (record) => {
                ...
                return (
                    <button
                        ...
                        className="rounded-lg bg-teal-50 px-3 py-1.5 text-xs font-black text-teal-700 transition hover:bg-teal-100 disabled:opacity-60"
                    >
            ...
            <Drawer isOpen={drawerOpen} onClose={() => setDrawerOpen(false)} title={config.addLabel} size="lg">
                <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {config.fields.map((field) => (
                            <label key={field.key} className="block">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm text-slate-900 focus:border-[#00b3a7] focus:outline-none focus:ring-2 focus:ring-[#00b3a7]/20"
                                />
                            </label>
                        ))}
                    </div>
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={createRecord.isPending} className="rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white shadow-sm disabled:opacity-60">
