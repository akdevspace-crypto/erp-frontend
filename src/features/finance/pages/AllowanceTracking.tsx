                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full h-24 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-black px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#00b3a7]/20 focus:border-[#00b3a7]"
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" className="px-4 py-2 rounded-xl bg-[#00b3a7] text-sm font-semibold text-white">
                            Save Claim
                        </button>
                    </div>
                </form>
