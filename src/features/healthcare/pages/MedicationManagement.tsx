...
export function MedicationManagement() {
        ...
        ...(canRequestMedicine ? [{
            ...
            cell: (product) => (
                <button
                    ...
                    className="rounded-lg bg-teal-50 px-3 py-1.5 text-xs font-black text-teal-700 transition hover:bg-teal-100 disabled:opacity-50"
                >
                    Request Issue
                </button>
            ),
    ...
    const summary = [
        { label: 'Medicines', value: medicines.length, tone: 'bg-teal-50 text-teal-700' },
                    ...
                    <div className="flex flex-wrap gap-2">
                        {canRequestMedicine ? (
                            <button
                                ...
                                className="inline-flex items-center gap-2 rounded-full border border-teal-100 bg-teal-50 px-4 py-2 text-xs font-black text-teal-700 hover:bg-teal-100"
                            >
            ...
            <section className="mb-6 flex min-h-[300px] flex-col gap-3">
                <div className="flex flex-wrap items-center justify-between gap-3 px-1">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-full bg-teal-50 px-4 py-2 text-xs font-black text-teal-700 transition hover:bg-teal-100 disabled:opacity-50"
                    >
                        <Send className="h-4 w-4" />
                        New Request
                    </button>
            ...
            <Drawer isOpen={medicineDrawerOpen} onClose={() => setMedicineDrawerOpen(false)} title="Add Medicine" size="md">
                <form onSubmit={handleCreateMedicine} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={isSavingMedicine} className="inline-flex items-center gap-2 rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#01867c] disabled:opacity-60">
            ...
            <Drawer isOpen={issueDrawerOpen} onClose={() => setIssueDrawerOpen(false)} title="Request Medicine Issue" size="md">
                <form onSubmit={handleRequestIssue} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={!canRequestMedicine || createIssueRequest.isPending || availableMedicineOptions.length === 0} className="rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#01867c] disabled:opacity-60">
                            Save Request
                        </button>
                    </div>
                </form>
