...
export function PatientDashboard() {
    ...
    const summary = [
        { label: 'Patients', value: patients.length, tone: 'bg-teal-50 text-teal-700' },
            ...
            <Drawer isOpen={patientDrawerOpen} onClose={() => setPatientDrawerOpen(false)} title="Add Patient" size="md">
                <form onSubmit={handleCreatePatient} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={createPatient.isPending} className="inline-flex items-center gap-2 rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white shadow-sm disabled:opacity-60">
            ...
            <Drawer isOpen={vitalDrawerOpen} onClose={() => setVitalDrawerOpen(false)} title="Record Patient Vitals" size="md">
                <form onSubmit={handleCreateVital} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={createVital.isPending || !patients.length} className="inline-flex items-center gap-2 rounded-xl bg-[#00b3a7] px-4 py-2 text-sm font-semibold text-white shadow-sm disabled:opacity-60">
                            <HeartPulse className="h-4 w-4" />
