                ...
                <div className="space-y-5 p-6">
                    {selectedTask ? (
                        <>
                            <div className="rounded-2xl border border-teal-100 bg-teal-50 p-4">
                                <p className="text-xs font-bold uppercase tracking-[0.18em] text-teal-700">Task</p>
                    ...
                    <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                        ...
                        <button
                            ...
                            disabled={!selectedTask || selectedTask.status !== 'COMPLETED' || updateTaskStatus.isPending}
                            className="px-4 py-2 rounded-md bg-teal-600 font-semibold text-white hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            Approve
                        </button>
                    </div>
