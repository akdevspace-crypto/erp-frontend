...
const colors = ['#14B8A6', '#0B5D6B', '#94D2A5', '#F59E0B', '#6366F1', '#F43F5E']
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap justify-end gap-3">
                {[
                    ...
                    <Link key={link.href} to={link.href} className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-black text-slate-800 shadow-sm hover:border-teal-200 hover:bg-teal-50">
                        {link.label}
                    ...
                    <div className="h-72">
                        <ResponsiveContainer width="100%" height="100%" minWidth={1} minHeight={1}>
                            <BarChart data={trendData}>
                                ...
                                <Bar dataKey="completed" fill="#0B5D6B" radius={[8, 8, 0, 0]} />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </div>
            ...
            <div className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
                <div className="mb-4 flex items-center justify-between gap-3">
                    ...
                    <Link to="/hr/reports" className="inline-flex items-center gap-2 rounded-full bg-teal-600 px-4 py-2 text-sm font-black text-white hover:bg-teal-700">
                        Reports
                        <ArrowRight className="h-4 w-4" />
                    </Link>
                </div>
                        ...
                        <tbody>
                            {actionRows.length > 0 ? actionRows.map((row) => (
                                <tr key={row.id} className="border-t border-slate-100">
                                    ...
                                    <td className="px-4 py-3"><span className="rounded-full bg-teal-50 px-2.5 py-1 text-xs font-black text-teal-700">{row.status}</span></td>
