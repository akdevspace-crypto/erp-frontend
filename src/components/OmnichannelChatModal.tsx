...
const getBubbleClassName = (channel?: string, outbound?: boolean) => {
    ...
    if (outbound) {
        return 'border-primary-500 bg-primary-600 text-white shadow-[0_18px_40px_rgba(0,179,167,0.25)]'
    }
                                                ...
                                                return (
                                                    <div key={message.id} className={cn('flex animate-in fade-in slide-in-from-bottom-2 duration-300', isOutbound ? 'justify-end' : 'justify-start')}>
                                                        <div className={cn(
                                                            ...
                                                            isOutbound
                                                                ? 'rounded-br-md border-primary-500 bg-primary-600 text-white shadow-[0_18px_40px_rgba(0,179,167,0.25)] dark:border-primary-500/30 dark:bg-primary-600/90'
